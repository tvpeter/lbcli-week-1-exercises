...
# WRITE YOUR SOLUTION BELOW:
P2SH_VALID=$(bitcoin-cli -regtest -rpcwallet="btrustwallet" validateaddress $P2SH_ADDR)
...
# WRITE YOUR SOLUTION BELOW:
INTERNAL_KEY=$(bitcoin-cli -regtest -rpcwallet=btrustwallet getdescriptorinfo $ADDR_INFO.desc)
...
# WRITE YOUR SOLUTION BELOW:
TAPROOT_DESCRIPTOR=$(bitcoin-cli -regtest -rpcwallet=btrustwallet getdescriptorinfo $SIMPLE_DESCRIPTOR.descriptor)
